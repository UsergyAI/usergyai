...
const HeroSection = () => {
  ...
  return (
    <section 
      id="hero" 
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-usergy-light via-white to-usergy-light pt-28 md:pt-32 lg:pt-36"
      role="banner"
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" id="main-content">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-8 justify-center items-center mb-10 sm:mb-12 md:mb-16 lg:mb-20 animate-scale-in px-4 max-w-4xl mx-auto">
            ...
            <Button 
              ...
              className="w-full sm:w-auto min-w-[280px] sm:min-w-[320px] border-2 border-usergy-coral text-usergy-coral hover:bg-usergy-coral hover:text-white font-bold text-base sm:text-lg py-4 sm:py-5 md:py-6 px-6 sm:px-8 md:px-12 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 focus:ring-2 focus:ring-usergy-coral focus:ring-offset-2"
