    ...
    <section className="py-16 md:py-24 section-wash relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl font-semibold text-muted-foreground mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-xl py-8 px-16 rounded-full shadow-2xl hover:shadow-primary/30 transform hover:scale-105 transition-all duration-300 animate-pulse-glow focus-visible:ring-2 focus-visible:ring-primary"
            >
            ...
            <Button 
              ...
              className="border-2 border-primary bg-background hover:bg-primary hover:text-primary-foreground text-primary font-bold text-xl py-8 px-16 rounded-full shadow-xl hover:shadow-primary/30 transform hover:scale-105 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-primary"
            >
