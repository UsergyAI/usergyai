        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-primary font-bold text-xl py-8 px-16 rounded-full shadow-2xl hover:shadow-primary/30 transform hover:scale-105 transition-all duration-300 animate-pulse-glow"
            >
            ...
            <Button 
              ...
              className="border-2 border-primary bg-white hover:bg-primary hover:text-primary-foreground text-primary focus-visible:ring-2 focus-visible:ring-primary font-bold text-xl py-8 px-16 rounded-full shadow-xl hover:shadow-primary/30 transform hover:scale-105 transition-all duration-300"
            >
