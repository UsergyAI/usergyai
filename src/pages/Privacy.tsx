  ...
  return (
    <>
      <SEOHead
        ...
        description="Learn how Usergy protects your privacy and handles your personal information. Our transparent privacy policy covers data collection, usage, and your rights."
        path="/privacy"
      />
              ...
              <article className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-12 animate-scale-in">
                <div className="prose prose-lg max-w-none">
                  <section aria-labelledby="information-collection">
                    <h2 id="information-collection" className="text-2xl font-bold text-usergy-dark mb-4">1. Information We Collect</h2>
                  ...
                  <section aria-labelledby="information-usage">
                    <h2 id="information-usage" className="text-2xl font-bold text-usergy-dark mb-4">2. How We Use Your Information</h2>
                    <p className="mb-6 text-gray-700 leading-relaxed">
                  ...
                  <section aria-labelledby="information-sharing">
                    <h2 id="information-sharing" className="text-2xl font-bold text-usergy-dark mb-4">3. Information Sharing</h2>
                    <p className="mb-6 text-gray-700 leading-relaxed">
                  ...
                  <section aria-labelledby="data-security">
                    <h2 id="data-security" className="text-2xl font-bold text-usergy-dark mb-4">4. Data Security</h2>
                    <p className="mb-6 text-gray-700 leading-relaxed">
                  ...
                  <section aria-labelledby="user-rights">
                    <h2 id="user-rights" className="text-2xl font-bold text-usergy-dark mb-4">5. Your Rights</h2>
                    <p className="mb-6 text-gray-700 leading-relaxed">
                  ...
                  <section aria-labelledby="contact-privacy">
                    <h2 id="contact-privacy" className="text-2xl font-bold text-usergy-dark mb-4">6. Contact Us</h2>
