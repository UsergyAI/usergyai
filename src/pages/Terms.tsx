...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 bg-gradient-to-br from-usergy-light via-white to-usergy-light">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-usergy-dark mb-4 sm:mb-6 leading-tight">
              Usergy Terms and Conditions
            </h1>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-600 mb-6 sm:mb-8">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Table of Contents */}
            <div className="bg-usergy-light/50 rounded-lg p-4 sm:p-6 mb-8 sm:mb-12">
              <h3 className="text-lg sm:text-xl font-bold text-usergy-dark mb-3 sm:mb-4">Table of Contents</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2">
                <button onClick={() => scrollToSection('introduction')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">Introduction</button>
                <button onClick={() => scrollToSection('about-platform')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">1. About Usergy Platform</button>
                <button onClick={() => scrollToSection('eligibility')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">2. Eligibility & Account Registration</button>
                <button onClick={() => scrollToSection('privacy')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">3. Personal Data & Privacy</button>
                <button onClick={() => scrollToSection('participation')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">4. Participation in Tests & Earning Rewards</button>
                <button onClick={() => scrollToSection('confidentiality')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">5. Confidentiality and Non-Disclosure</button>
                <button onClick={() => scrollToSection('conduct')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">6. Community Conduct and Guidelines</button>
                <button onClick={() => scrollToSection('termination')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">7. Termination of Use</button>
                <button onClick={() => scrollToSection('intellectual-property')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">8. Intellectual Property and Use of Content</button>
                <button onClick={() => scrollToSection('disclaimers')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">9. Disclaimers and Limitation of Liability</button>
                <button onClick={() => scrollToSection('changes')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">10. Changes to these Terms</button>
                <button onClick={() => scrollToSection('contact')} className="text-left text-usergy-turquoise hover:text-usergy-skyblue transition-colors py-1 text-sm sm:text-base">11. Contact Us</button>
              </div>
            </div>

            {/* Introduction */}
            <section id="introduction" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">Introduction</h2>
            ...
            {/* Section 1 */}
            <section id="about-platform" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">1. About Usergy Platform</h2>
            ...
            {/* Continue with remaining sections using similar responsive patterns... */}
            
            {/* Section 2 */}
            <section id="eligibility" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">2. Eligibility & Account Registration</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="privacy" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">3. Personal Data & Privacy</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="participation" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">4. Participation in Tests & Earning Rewards</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="confidentiality" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">5. Confidentiality and Non-Disclosure</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="conduct" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">6. Community Conduct and Guidelines</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="termination" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">7. Termination of Use</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="intellectual-property" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">8. Intellectual Property and Use of Content</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="disclaimers" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">9. Disclaimers and Limitation of Liability</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="changes" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">10. Changes to these Terms</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
            ...
            <section id="contact" className="mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-usergy-dark mb-4 sm:mb-6">11. Contact Us</h2>
              <div className="text-base sm:text-lg text-gray-700 leading-relaxed space-y-3 sm:space-y-4">
                <p>If you have questions about these Terms or need support:</p>
                <ul className="list-disc list-inside space-y-1 sm:space-y-2 ml-2 sm:ml-4">
                  <li>Email us at: <a href="mailto:swaroop@usergy.ai" className="text-usergy-turquoise hover:text-usergy-skyblue break-words">swaroop@usergy.ai</a></li>
            ...
            {/* Closing Statement */}
            <section className="bg-usergy-light/30 rounded-lg p-6 sm:p-8 mb-8 sm:mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-usergy-dark mb-3 sm:mb-4">Thank You for Being Part of Usergy!</h2>
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
            ...
            {/* Contact CTA */}
            <div className="text-center bg-gradient-to-r from-usergy-turquoise/10 to-usergy-skyblue/10 rounded-lg p-4 sm:p-6">
              <p className="text-base sm:text-lg text-gray-700 mb-3 sm:mb-4">
                Have questions about these terms?
              </p>
              <a 
                href="mailto:swaroop@usergy.ai" 
                className="inline-block bg-usergy-turquoise hover:bg-usergy-skyblue text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all duration-300 hover:shadow-lg text-sm sm:text-base"
              >
